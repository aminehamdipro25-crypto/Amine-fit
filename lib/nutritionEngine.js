...
// Recomposition override: currentWeight vs targetWeight beats the selected goal
export function calcTarget(tdee, goalKey, gender = 'male', currentWeight = null, targetWeight = null) {
  const floor = gender === 'male' ? 1500 : 1200
  const cw = currentWeight != null ? +currentWeight : null
