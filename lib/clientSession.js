...
async function redisPipeline(commands) {
  ...
  try {
    ...
    return res.json()
  } catch (e) { console.error('[redisPipeline]', e.message); return null }
}
...
export async function createClientSession(clientId) {
  ...
  } catch (e) { console.error('[createClientSession]', e.message) }
  return sessionId
}
...
export async function createPreviewSession(clientId) {
  ...
  } catch (e) { console.error('[createPreviewSession]', e.message) }
  return sessionId
}
...
export async function deleteClientSession(clientId) {
  ...
  } catch (e) { console.error('[deleteClientSession]', e.message) }
}
...
export async function updateLastSeen(clientId) {
  ...
  } catch (e) { console.error('[updateLastSeen]', e.message) }
}
