const stats = [
  { value: '100+', label: 'عميل مدرَّب',   desc: 'خلال مسيرة تزيد عن 10 سنوات' },
  { value: '95%',  label: 'نسبة النجاح',   desc: 'من العملاء يصلون لهدفهم' },
  { value: '10+',  label: 'سنوات خبرة',    desc: 'في التدريب الشخصي والتغذية' },
  { value: '24h',  label: 'وقت الاستجابة', desc: 'رد مضمون عبر واتساب' },
]
