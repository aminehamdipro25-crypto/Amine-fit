...
const faqs = [
  ...
  },
  {
    ...
    a: 'لا مشكلة — الحياة تحدث. أُبلغ مدربك عبر واتساب أو من خلال التقرير الأسبوعي في بوابة العميل، وسيُعدّل البرنامج وفقاً لذلك. الهدف هو الاستمرارية على المدى الطويل وليس الكمال.',
  },
  {
  ...
  },
  {
    ...
    a: 'التواصل يتم عبر واتساب (+974 30653759). بعد الاتفاق على الباقة، يرسل المدرب تفاصيل الدفع ثم يُفعِّل حسابك في بوابة العميل التي تتضمن خطتك الغذائية والتدريبية الكاملة.',
  },
  {
