...
const experience = [
  {
    ...
    highlight: true,
    points: [
      'تصميم وتنفيذ برامج تكييف بدني لغواصي ووحدات القوات الخاصة (20–40 عنصر)',
      'مراقبة المؤشرات الفردية وضبط الخطط التدريبية لمعايير الاستعداد القتالي',
      'تسجيل صفر إصابات تدريبية خلال كامل مدة الخدمة',
    ],
  },
  {
    ...
    points: [
      'تدريس التكييف البدني واليوغا العلاجية والوقاية من الإصابات للطلاب العسكريين',
      'تطبيق بروتوكولات الوقاية المبنية على الأدلة لتقليل الشكاوى العضلية',
    ],
  },
  {
    ...
    color: 'border-white/20',
    points: [
      'قيادة 3 جلسات أسبوعية للمجموعات (8–15 مشارك) بمعدل احتفاظ 85%+',
      'تطوير برامج تركز على تخفيف التوتر، تقوية العمق، وتصحيح الوضعية',
    ],
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/30 max-w-2xl mx-auto font-medium text-sm leading-relaxed">
            خبير رياضي وتغذوي نادر الجمع — بين الانضباط العسكري النخبوي والمعرفة الأكاديمية المعتمدة
          </p>
        </div>
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-[#111] to-[#1a1a1a] border border-white/8 rounded-3xl p-7 mb-6">
              ...
              <p className="text-white/55 text-sm leading-relaxed mb-5">
                متخصص في التربية البدنية بخبرة تتجاوز <strong className="text-white/80">10 سنوات</strong> تجمع
                بين التكييف العسكري النخبوي والحركة العلاجية — من تصميم برامج جاهزية قتالية للقوات الخاصة
                والغواصين البحريين، إلى قيادة اليوغا العلاجية والتغذية في البيئات المدنية.
              </p>

              {/* Quote */}
              <blockquote className="border-r-4 border-gold-400 pr-4">
                <p className="text-white/60 text-sm italic leading-relaxed">
                  "التحول الحقيقي لا يبدأ في الصالة — يبدأ في العقل. أنا هنا لأعطيك الخطة والانضباط معاً."
                </p>
                <cite className="text-gold-400 text-xs font-bold mt-2 block">— أمين حمدي</cite>
              </blockquote>
            </div>
