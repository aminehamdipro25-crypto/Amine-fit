...
import { Users, TrendingUp, Calendar, ClipboardList, ArrowUpRight, Clock, CheckCircle2, Eye } from 'lucide-react'
import {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-slate-400 bg-slate-100 px-3 py-1 rounded-full">2025 — بيانات تجريبية</span>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          {total === 0 && <p className="text-xs text-slate-400 text-center mt-2">بيانات تجريبية</p>}
        </div>
      </div>
