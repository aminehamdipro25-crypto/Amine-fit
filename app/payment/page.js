...
import { Check, Zap, MessageCircle, Copy, CheckCheck, Smartphone } from 'lucide-react'
...
export default function PaymentPage() {
  ...
  function waMessage() {
    ...
    return encodeURIComponent(
      `مرحباً أمين 👋\nلقد أرسلت ${plan.price} ${plan.currency} عبر D17 للاشتراك في ${plan.name}.\nأرجو تفعيل حسابي.`
    )
  }
    ...
    <div className="min-h-screen bg-[#0a0a0a]" dir="rtl">
      ...
      {step === 2 && plan && (
        <div className="max-w-lg mx-auto px-4 pb-20">
          ...
          {/* Summary card */}
          <div className="bg-white/5 border border-white/10 rounded-3xl p-6 mb-6 flex items-center gap-4">
            ...
            <button onClick={() => setStep(1)} className="mr-auto text-xs text-white/30 hover:text-white/60 underline transition">تغيير</button>
          </div>
          ...
          <div className="bg-[#1a1a1a] border border-white/10 rounded-3xl p-6 mb-4">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h2 className="text-white font-extrabold text-base">ادفع عبر D17</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-bold text-sm mb-2">أرسل <span className="text-[#fbbf24]">{plan.price} {plan.currency}</span> إلى رقم D17:</p>
          ...
          {/* WhatsApp CTA */}
          <a href={`https://wa.me/${WA}?text=${waMessage()}`}
