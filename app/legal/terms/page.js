  ...
  return (
    <div className="prose prose-invert max-w-none">
      ...
      {[
        ...
        { title: '3. الاشتراك والدفع', body: 'تُدفع الرسوم شهرياً مسبقاً. الأسعار بالريال القطري وقابلة للتغيير مع إشعار مسبق بـ 30 يوماً. لا يحق المطالبة باسترداد المال عند انتهاء الفترة المدفوعة.' },
