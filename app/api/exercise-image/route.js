...
const STATIC_MAP = {
  ...
  // ── Push-Up family (bodyweight — no barbell) ──────────────────────────────
  'Push-Up':                       IMG('Push-Up'),
  'Push Up':                       IMG('Push-Up'),
  'Pushup':                        IMG('Push-Up'),
  'Push-Ups':                      IMG('Push-Up'),
  'Push Ups':                      IMG('Push-Up'),
  'Wide Push-Up':                  IMG('Push-Up'),
  'Push-Up (Wide Grip)':           IMG('Push-Up'),
  'Wide Grip Push-Up':             IMG('Push-Up'),
  'Diamond Push-Up':               IMG('Push-Up'),
  'Close-Grip Push-Up':            IMG('Push-Up'),
  'Narrow Push-Up':                IMG('Push-Up'),
  'Pike Push-Up':                  IMG('Push-Up'),
  'Incline Push-Up':               IMG('Push-Up'),
  'Decline Push-Up':               IMG('Push-Up'),
  'Knee Push-Up':                  IMG('Push-Up'),
  'Archer Push-Up':                IMG('Push-Up'),
  'Clap Push-Up':                  IMG('Push-Up'),
  // ── Legs ───────────────────────────────────────────────────────────────────
  ...
  'Dumbbell Reverse Lunge':        IMG('Dumbbell_Squat'),
  'Dumbbell Walking Lunge':        IMG('Dumbbell_Squat'),
  ...
  'Superman Hold':                 IMG('Good_Morning'),
