...
const STATIC_MAP = {
  ...
  // ── Cardio / Machines ─────────────────────────────────────────────────────
  'Running':                       IMG('Mountain_Climbers'),
  'Jogging':                       IMG('Mountain_Climbers'),
  'Light Jogging':                 IMG('Mountain_Climbers'),
  'Easy Jogging':                  IMG('Mountain_Climbers'),
  'Brisk Walking':                 IMG('Mountain_Climbers'),
  'Walking':                       IMG('Mountain_Climbers'),
  'Sprint':                        IMG('Mountain_Climbers'),
  'Sprinting':                     IMG('Mountain_Climbers'),
  'Sprint Intervals':              IMG('Mountain_Climbers'),
  'Sprint Run':                    IMG('Mountain_Climbers'),
  'Hill Sprints':                  IMG('Mountain_Climbers'),
  'Elliptical':                    IMG('Mountain_Climbers'),
  'Elliptical Trainer':            IMG('Mountain_Climbers'),
  'Cycling':                       IMG('Mountain_Climbers'),
  'Stationary Bike':               IMG('Mountain_Climbers'),
  'Stationary Cycling':            IMG('Mountain_Climbers'),
  'Indoor Cycling':                IMG('Mountain_Climbers'),
  'Bike':                          IMG('Mountain_Climbers'),
  'Swimming':                      IMG('Mountain_Climbers'),
  'Rowing Machine':                IMG('Bent_Over_Barbell_Row'),
  'Row Machine':                   IMG('Bent_Over_Barbell_Row'),
  'Battle Rope':                   IMG('Mountain_Climbers'),
  'Battle Ropes':                  IMG('Mountain_Climbers'),
  'Stair Climber':                 IMG('Mountain_Climbers'),
  'Stair Climbing':                IMG('Mountain_Climbers'),
  'Jumping Jacks':                 IMG('Mountain_Climbers'),
  'High Knees':                    IMG('Mountain_Climbers'),
  'Skipping':                      IMG('Mountain_Climbers'),
  'Jump Skipping':                 IMG('Mountain_Climbers'),
  'Kettlebell Swing':              IMG('Barbell_Hip_Thrust'),
  'KB Swing':                      IMG('Barbell_Hip_Thrust'),
  'Kettlebell Swings':             IMG('Barbell_Hip_Thrust'),
  'Treadmill':                     IMG('Mountain_Climbers'),
  'Treadmill Running':             IMG('Mountain_Climbers'),
  'Foam Rolling':                  IMG('Plank'),
  'Stretching':                    IMG('Plank'),
  'Dynamic Stretching':            IMG('Plank'),
  'Static Stretching':             IMG('Plank'),
  'Walking Lunges':                IMG('Barbell_Lunge'),
  'Inchworm':                      IMG('Plank'),
  'Bear Crawl':                    IMG('Mountain_Climbers'),
  'Broad Jump':                    IMG('Barbell_Full_Squat'),
