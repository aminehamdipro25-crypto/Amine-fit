...
<div style="max-width:520px;margin:0 auto;background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.08)">
  ...
  <div style="padding:22px 24px">
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:18px">
      <tr>
        <td style="padding:12px;background:#faf5ff;border-radius:10px;width:48%;vertical-align:top">
          <p style="margin:0 0 4px;font-size:11px;font-weight:bold;color:#7c3aed;text-transform:uppercase">مستوى الطاقة</p>
          <p style="margin:0;font-size:28px;font-weight:900;color:#1e1b4b">${e.energy}/5</p>
          <p style="margin:4px 0 0;font-size:13px;color:#6d28d9">${ENERGY_LABELS[e.energy] || ''}</p>
        </td>
        <td style="width:4%"></td>
        <td style="padding:12px;background:#eff6ff;border-radius:10px;width:48%;vertical-align:top">
          <p style="margin:0 0 4px;font-size:11px;font-weight:bold;color:#1d4ed8;text-transform:uppercase">متوسط النوم</p>
          <p style="margin:0;font-size:28px;font-weight:900;color:#1e3a8a">${e.sleep} ساعة</p>
          <p style="margin:4px 0 0;font-size:13px;color:${sleepOk ? '#059669' : '#dc2626'}">${sleepOk ? '✅ ممتاز' : '⚠️ يحتاج تحسين'}</p>
        </td>
      </tr>
    </table>

    <div style="margin-bottom:14px">
      <p style="margin:0 0 6px;font-size:12px;font-weight:bold;color:#374151">🏋️ التدريب — ${e.trainingDone} أيام من 7</p>
    ...
    <div style="margin-bottom:18px">
      <p style="margin:0 0 6px;font-size:12px;font-weight:bold;color:#374151">🥗 الالتزام بالتغذية — ${e.nutritionDays} أيام من 7</p>
      <div style="background:#e5e7eb;border-radius:99px;height:10px;overflow:hidden">
    ...
    ${e.note ? `
    <div style="background:#f8f9fa;border-right:3px solid #7c3aed;padding:12px 14px;border-radius:8px;margin-bottom:18px">
